...
CContrabbassi =  \relative f {
	...
	\cueDuringWithClef #"CVioliniI" #UP #"treble^8" { R1 }
    f1\mp\upbow | % 9
    ...
    <<
        ...
        \new StaffGroup <<
            ...
            \new Staff <<
                ...
                >>
            \new Staff <<
                \set Staff.instrumentName = "Vl. III"
