...
KFagottoI =  \relative b, {
    ...
    R1*2 | % 24
    r4 e'4(^"a 2" f4 fis4 g4 gis4 a4 ais4 | % 25
    b2) r4 b4^"Solo" c4( b4) b2 | % 26
    R1*8 | \barNumberCheck #30
...
KVioliniI =  \relative d' {
    ...
    d4\downbow\f\breathe d'4\downbow ~ d8 cis16 d16 e8 g,8\upbow | % 2
    fis4\breathe fis'4\downbow ~ fis8 e16 fis16 g8 b,8\upbow | % 3
    a4\breathe a'4\downbow ~ a8 g16 a16 b8\upbow cis8\upbow | % 4
    ...
    b1\downbow ^"Tutti"\mp ~ b4\breathe g8\downbow a8 b4 a8 b8 | % 23
    ...
    a2 r2 r1 | % 33
    R1*6 | % 36
    d4\mf\downbow d2\upbow d2 d2 d4 ~ | % 37
    d4 d2 d2 d2 d4 ~ | % 38
...
KVioliniII =  \relative e' {
    \clef "treble" \key d \major \time 4/4 r2 e4\f\downbow\breathe e'4\downbow ~ | % 2
    e8 d16 cis16 d8 a8\upbow g4\downbow\breathe g'4\downbow ~ | % 3
    g8 fis16 e16 fis8 d8\upbow b4 d4 | % 4
    a2 d2 | % 5
    e1 ^\fermata \bar "||"
    \time 4/2  <a,, fis' d'>4\downbow r4 r2 r1 | % 7
    R1*4 | % 9
    d'4 \downbow^"Solo" fis8 e8 d4 e4\upbow fis8 e8 fis8 gis8 a4 \breathe d,8\downbow cis8 |
    \barNumberCheck #10
    b2. e4 a,2. e4 | % 11
	...
	\tag #'part { \new CueVoice { \set instrumentCueName = "Fl. I" } }
	\cueDuring #"KFlautoI" #UP { R\breve*2 }
    r2 r4 g'8\mp\downbow^"Tutti"  fis8 e4 fis4 fis2 | % 23
    ...
    g4 :8 d4 :8 e2 ->\downbow fis2 ->\upbow e2 -> | % 31
    a2 -> d,2 :8 dis2 :8 e2 :8 | % 32
    d2 r2 r1 | % 33
    R1*6 | % 36
    d'4\mf\downbow d2\upbow d2 d2 d4 ~ | % 37
    d4 d2 d2 d2 d4 ~ | % 38
    d4 r4 r2 r4 b4\f\upbow a4 b4 | % 39
    g2 a2 d,1 ~ | \barNumberCheck #40
    d4 cis4\downbow d4 e4 d1 | % 41
    a1 a'1 | % 42
    a1. g2 ~\upbow | % 43
    g2 fis2\upbow g1 | % 44
    g1. a2\upbow | % 45
    b\breve | % 46
    a\breve\upbow ~ | % 47
    a\breve\downbow^"~" ^\fermata \bar "|."
    }

KVioleI =  \relative d' {
    \clef "alto" \key d \major \time 4/4
    d4.\f\downbow fis,8\downbow a2\upbow | % 2
    a4. cis8\downbow b2 | % 3
    cis4. a8\downbow d4 g4 | % 4
    fis4 e4 e2 | % 5
    a1 ^\fermata \bar "||"
    ...
    r4 d,4\upbow ^"Tutti" e4 d4 g2 fis2 | % 17
    r4 a8\downbow b8 c4 d8 c8 b4 a8 g8 a4 d,4 | % 18
    g2 fis4 g8 fis8 e1 | % 19
    d1 r1 | \barNumberCheck #20
    R1*4 | % 22
    r4 fis'8\mf\downbow g8 a4 b8 a8 g4 fis8 e8 fis4 b,4 | % 23
    e2 dis2 cis2 r4 fis4\upbow\mp | % 24
    e2 a,2 ~ a4 d4\upbow c2 ~ | % 25
    c2. :8 b4 :8 c4 :8 b4 :8 b2 :8 | % 26
    a1 :8 r1 | % 27
    r1 r2 e'4 :8\downbow d4 :8 | % 28
    d4 :8 e4 :8 e2 :8 d2 :8 e4 :8 c4 :8 | % 29
    b4 :8 d4 :8 c2 :8 a2 :8 c4 :8 e4 :8 | \barNumberCheck #30
    d2 :8 r2 r1 | % 31
    r2 a1 :8\downbow a2 :8 | % 32
    a2 r2 r1 | % 33
    R1*6 | % 36
    d4\mf\downbow d2\upbow d2 d2 d4 ~ | % 37
    d4 d2 d2 d2 d4 ~ | % 38
    d4 r4 r2 r1 | % 39
    r4 d4\f\upbow e4 d4 g2 fis2 | \barNumberCheck #40
    b2 bes2 a2 gis2 | % 41
...
KVioleII =  \relative g' {
    \clef "alto" \key d \major \time 4/4
    r2 g4.\f\downbow cis,8\downbow | % 2
    d2\upbow d4. e8\downbow | % 3
    e2 fis4. e8\downbow | % 4
    d2 e4. e8\upbow | % 5
    e1 ^\fermata \bar "||"
    ...
    d1 r1 | \barNumberCheck #20
    R1*4 | % 22
    dis'2\mp\downbow e4 dis4 b4 c4 b2 | % 23
    a4.--( b8-.) c4\upbow b4\upbow e2 d2 | % 24
    c1 ~ c4 b4\upbow a4 g4 | % 25
    a1 :8 r4 gis4 :8\downbow a4 :8 gis4 :8 | % 26
    a\breve :8 | % 27
    b1. :8 a4 :8 gis4 :8 | % 28
    a\breve :8 | % 29
    b4 :8 g2 :8 g4 :8 d4 :8 fis4 :8 a2 :8 | \barNumberCheck #30
    b4 :8 g4 :8 g2 :8 d2 :8 r2 | % 31
    r2 g1 :8\downbow g2 :8 | % 32
    fis2 r2 r1 | % 33
    R1*6 | % 36
    d'4\mf\downbow d2\upbow d2 d2 d4 ~ | % 37
    d4 d2 d2 d2 d4 ~ | % 38
    d4 r4 r2 r1 | % 39
    r1 r4 b4\f\upbow a4 b4 | \barNumberCheck #40
    g1 a2 b2\downbow | % 41
    e,4\upbow fis8 g8 a2. e4 a2 | % 42
    a2 r4 a4\upbow g2\downbow r4 g4 | % 43
...
KVioloncelli =  \relative d {
    ...
    d8\downbow\f e8 fis8 d8 a8 b8 cis8 a8 | % 2
    ...
    e2 d2 c1 | % 25
    b1 r4 e,4\mf\upbow fis4 e4 | % 26
    g1 fis1 | % 27
    a1 gis2 a4 b4 | % 28
    c4 r4 r2 r4 e4\downbow a4 g8 fis8 | % 29
    e2 c2 d2 a4 b8 c8 | \barNumberCheck #30
    b2 c2 d2 e2 | % 31
    a,4 g8 a8 b4 a8 b8 c4 b8 c8 cis4\upbow cis4\upbow | % 32
    d2 r2 r1 | % 33
    R1*6 | % 36
    ...
    a\breve\upbow^"~" ~ | % 41
    a\breve | % 42
    d,2\f r4 d4\upbow g2\downbow r4 g4 | % 43
...
KContrabbassi =  \relative d {
    \transposition c \clef "bass" \key d \major \time 4/4
    d8\f\downbow e8 fis8 d8
    a8 b8 cis8 a8 | % 2
    d8 e8 fis8 d8 e8 d8 e8 e,8 | % 3
    fis8 g8 a8 fis8 g8 fis8 e8 g8 | % 4
    a8 b8 c8 a8 b8 c8 b8 b8 | % 5
    ...
    b1 r1 | % 26
    R1*4 | % 28
    r4 b'8\mf\downbow c8 d4 c4 b4 r4 r2 | % 29
    r2 c,2\upbow d2 a4 b8 c8 | \barNumberCheck #30
    b2 c2 d2 e2 | % 31
    a,2 r2 r1 | % 32
    R1*12 | % 38
    ...
    a,\breve ~ | % 41
    a\breve | % 42
    d2\f r4 d4\upbow g,2\downbow r4 g4 | % 43
    a2 r4 a4 b2 r4 b4 | % 44
    c1. b2 | % 45
    a1 c2 a2\upbow | % 46
    d\breve ~ | % 47
...
KSoprano =  \relative a' {
    \clef "treble" \key d \major \time 4/4 R1*5 \bar "||"
    \time 4/2  R1*2^"leggiero" | % 7
    R1*4 | % 9
    r4 a4\f b4 a4 d2 cis2 | \barNumberCheck #10
    r4 e8 fis8 g4 a8 g8 fis4 e8 d8 e4 a,4 | % 11
    d2 cis2 b1 | % 12
    a1 r4 cis8\mf d8 e4 d8 cis8 | % 13
...
KAlto =  \relative d' {
    \clef "treble" \key d \major \time 4/4 R1*5 \bar "||"
    \time 4/2  r4 d4\f e4 d4 g2 fis2 | % 7
    r4 a8 b8 c4 d8 c8 b4 a8 g8 a4 d,4 | % 8
    g2 fis2 e1 | % 9
    d2 r4 cis4\mf b4 e4 a,4 a'4 | \barNumberCheck #10
...
KTenore =  \relative d {
    ...
    R1*8 | % 37
    R1*4 | % 39
    r4 d'4\f e4 d4 g2 fis2 | \barNumberCheck #40
    b,2 bes2 a2 gis2 | % 41
    a\breve | % 42
    R1*4 | % 44
    r1 r2 d2 | % 45
