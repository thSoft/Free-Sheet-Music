...
FRHII =  \relative c' {
    ...
    g4 _\trill \grace { fis16 [ g16 ] } a4 c,4 \rest | \barNumberCheck
    #50
    c4 \rest e4 g4 | % 51
...
FLHI =  \relative d {
    ...
    a4 ~ a16 [ g16 fis16 es16 ] g16 [ fis16 es16 d16 ] | \barNumberCheck
    #30
    ...
    \key d \major c16 \rest cis8 ^\trill [ b16 ] cis8. c16 \rest c4
    \rest | % 53
    r8 a'8 [ gis8 g8 fis8 f8 ] | % 54
